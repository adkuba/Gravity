...
namespace DeltaDNA.Editor {
    ...
    internal abstract class SdkChecker {
        ...
        static SdkChecker() {
            // GameGrowth update: Disabling warning log for DDNA problems after every domain load/reload unless in playing mode. This avoids constant logs on package installation.
